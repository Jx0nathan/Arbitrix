...
import io.arbitrix.core.strategy.base.enums.ApplicationExecuteStrategyEnum;
 ...
 */
@FunctionalInterface
public interface OrderBookDepthEventListener {
     ...
     */
    void onDepthOrderBook(String exchangeName, List<BookTickerEvent> bookTickerEventList);
    ...
    /**
     * 当前执行器的策略名字
     * @return 策略名字 {@link ApplicationExecuteStrategyEnum}
     */
    default String getCurrentStrategyName() {
        return null;
    }
}
