 ...
 * @author jonathan.ji
 */
public class FutureOpenExecutor extends AbstractThreadPoolExecutor {
    private static final ThreadPoolExecutor THREAD_POOL_EXECUTOR = new FutureOpenExecutor();

    /**
     * 阻塞队列设置了10个，如果接口的响应时间为100ms，那么阻塞的时间就得要1s
     * 抛弃策略：抛弃队列中最老的任务
     */
    private FutureOpenExecutor() {
        super(1
                , 1
